...
#define TFC_HBRIDGE_FB_A_ADC_CHANNEL		7
#define TFC_HBRIDGE_FB_B_ADC_CHANNEL		3
...
void ADC0_IRQHandler()
{
	...
	switch(CurrentADC_State)
	{
		...
		case ADC_STATE_CAPTURE_BATTERY_LEVEL:
				...
				ADC0_CFG2  &= ~ADC_CFG2_MUXSEL_MASK; //Select the A side of the mux
				ADC0_SC1A  =  TFC_HBRIDGE_FB_A_ADC_CHANNEL | ADC_SC1_AIEN_MASK;
				CurrentADC_State = ADC_STATE_CAPTURE_HBRIDGE_A;
				
				break;
				
		case ADC_STATE_CAPTURE_HBRIDGE_A:	
			
				HBridge_Value[0] = ADC0_RA;
						
				ADC0_CFG2  &= ~ADC_CFG2_MUXSEL_MASK; //Select the A side of the mux
				ADC0_SC1A  =  TFC_HBRIDGE_FB_B_ADC_CHANNEL | ADC_SC1_AIEN_MASK;
				CurrentADC_State = ADC_STATE_CAPTURE_HBRIDGE_B;
				
				break;
			
		case ADC_STATE_CAPTURE_HBRIDGE_B:	
			
				HBridge_Value[1] = ADC0_RA;
