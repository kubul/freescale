...
Sources/Spices.o: ../Sources/Spices.c
	...
	"$(ARMSourceryDirEnv)/arm-none-eabi-gcc" "$<" @"Sources/Spices.args" -Wa,-adhlns="$@.lst" -MMD -MP -MF"$(@:%.o=%.d)" -o"Sources/Spices.o"
...
Sources/demo.o: ../Sources/demo.c
	...
	@echo 'Invoking: ARM Ltd Windows GCC C Compiler'
	"$(ARMSourceryDirEnv)/arm-none-eabi-gcc" "$<" @"Sources/demo.args" -Wa,-adhlns="$@.lst" -MMD -MP -MF"$(@:%.o=%.d)" -o"Sources/demo.o"
	@echo 'Finished building: $<'
	@echo ' '
