...
void TFC_InitGPIO()
{
	...
	//Setup Pins as GPIO
	PORTB_PCR20 = PORT_PCR_MUX(1) | PORT_PCR_DSE_MASK | PORT_PCR_PE_MASK;   //HBRIDGE ENABLE
	...
	PORTE_PCR26 = PORT_PCR_MUX(1) | PORT_PCR_DSE_MASK;  // green
    ...
    GPIOB_PDDR |=  TFC_BAT_LED2_LOC;
    GPIOA_PDDR |=  TFC_BAT_LED3_LOC;
