...
#define TFC_POT_0_ADC_CHANNEL		15
#define TFC_POT_1_ADC_CHANNEL		14
#define TFC_HBRIDGE_FB_A_ADC_CHANNEL		20
...
void InitADC()
{
	...
	Master_Adc_Config.COMPARE2 = 0xFFFF;
...
void ADC1_IRQHandler()
{
	...
	case ADC_STATE_CAPTURE_POT_0:
		...
		CurrentADC1_State = ADC_STATE_CAPTURE_POT_1;
	...
	case ADC_STATE_CAPTURE_POT_1:
		...
		CurrentADC1_State = ADC_STATE_CAPTURE_HBRIDGE_A;
	...
	case ADC_STATE_CAPTURE_HBRIDGE_A:	
		...
		ADC1_CFG2  &= ~ADC_CFG2_MUXSEL_MASK; //Select the A side of the mux
		ADC1_SC1A  =  TFC_HBRIDGE_FB_B_ADC_CHANNEL | ADC_SC1_AIEN_MASK;
		CurrentADC1_State = ADC_STATE_CAPTURE_HBRIDGE_B;
